                ...
                <div class="row justify-content-center">
                    <div class="col-xl-4 text-center">
                        <div class="error-500 position-relative">
                            <img src="{{ asset('velzon/assets/') }}/images/error500.png" alt=""
                                class="img-fluid error-500-img error-img" />
                            <h1 class="title text-muted">500</h1>
                        </div>
                        <div>
                            <h4>Internal Server Error!</h4>
                            <p class="text-muted w-75 mx-auto">Kesalahan Server 500. Kami tidak yakin apa yang terjadi,
                                tetapi server kami mengatakan ada yang tidak beres.</p>
                            <a href="{{ route('home') }}" class="btn btn-info"><i class="mdi mdi-home me-1"></i>Back to
                                home</a>
                        </div>
                    </div><!-- end col-->
                </div>
